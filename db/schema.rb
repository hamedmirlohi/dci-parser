...
ActiveRecord::Schema.define(version: 20140916041507) do
  ...
  create_table "packets", force: true do |t|
    ...
    t.integer  "access_vec0",      limit: 8
    t.integer  "access_vec1",      limit: 8
    t.integer  "access_vec2",      limit: 8
    t.integer  "access_vec3",      limit: 8
    t.integer  "pmc_hand_ack",     limit: 8
    t.integer  "pmc_hand_en",      limit: 8
    t.integer  "outband_pad",      limit: 8
    t.integer  "outband_pack",     limit: 8
    t.integer  "transport",        limit: 8
    t.integer  "jtag_muxsel",      limit: 8
    t.integer  "enable_jtag_s",    limit: 8
    t.integer  "disable_jtag_s",   limit: 8
    t.integer  "free_run_clk",     limit: 8
    t.integer  "flush_wb",         limit: 8
    t.integer  "force_wb_to",      limit: 8
    t.integer  "force_st_to",      limit: 8
    t.integer  "force_wb",         limit: 8
    t.integer  "force_st",         limit: 8
    t.integer  "jtag_clk_src",     limit: 8
    t.integer  "jtag_duty",        limit: 8
    t.integer  "jtag_second",      limit: 8
    t.integer  "jtag_first",       limit: 8
    t.integer  "jtag_tdo_rec",     limit: 8
    t.integer  "jtag_jtag_chain",  limit: 8
    t.integer  "jtag_to_clk_src",  limit: 8
    t.integer  "jtag_to_sec_pre",  limit: 8
    t.integer  "jtag_to_fir_pre",  limit: 8
    t.integer  "scan_trig0",       limit: 8
    t.integer  "scan_trig1",       limit: 8
    t.integer  "scan_trig2",       limit: 8
    t.integer  "scan_trig3",       limit: 8
    t.integer  "jtag_trst",        limit: 8
    t.integer  "jtag_preq",        limit: 8
    t.integer  "jtag_reset",       limit: 8
    t.integer  "jtag_power",       limit: 8
    t.integer  "jtag_prdy",        limit: 8
    t.integer  "jtag_rst_break",   limit: 8
    t.integer  "jtag_pwrbrk1",     limit: 8
    t.integer  "jtag_pwrbrk2",     limit: 8
    t.integer  "jtag_pwrbrk3",     limit: 8
    t.integer  "jtag_pkt_comp",    limit: 8
    t.integer  "jtag_tap_pwr",     limit: 8
    t.integer  "jtag_cpu_tap",     limit: 8
    t.integer  "jtag_S0Ix",        limit: 8
    t.integer  "jtag_mState",      limit: 8
    t.integer  "jtag_small_core",  limit: 8
    t.integer  "jtag_plat_rst",    limit: 8
    t.integer  "jtag_cpu_warm",    limit: 8
    t.integer  "jtag_nc_warm",     limit: 8
    t.integer  "jtag_soc_warm",    limit: 8
    t.integer  "jtag_handler",     limit: 8
    t.integer  "jtag_exi_bridge",  limit: 8
    t.integer  "jtag_timeout",     limit: 8
